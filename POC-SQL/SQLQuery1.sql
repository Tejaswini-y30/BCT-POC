...
CREATE PROCEDURE deleting_category   
    @set_CategoryID int     
AS   

    SET NOCOUNT ON;  

	DELETE from tblCategory where CategoryID= @set_CategoryID
    
GO


-----COST LESS THAN GIVEN
...
AS   
	...
	SELECT ProductID,ProductDescription,ProductColor,ProductSize from tblProduct where Cost<= @set_Cost
GO
